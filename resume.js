(() => {
  ...
  const copy = {
    ...
    zh: {
      ...
      humanoidValidation: "将 MimicLite 适配至 31 自由度 A3Ultra，训练 PPO 跟踪策略，完成 sim-to-sim 评估与 Orin 推理验证。协作减少受保护真机测试中的抖动，将响应延迟定位至时钟未对齐并修正时序，后续测试未再出现该延迟。",
      ...
      complianceTitle: "FAIRINO 阻抗与导纳实验", complianceStatus: "已完成真机验证",
      complianceCopy: "开发可配置实验执行工具，加入参数检查与退出处理，通过 mock-SDK 测试验证指令序列，并完成真机验证。",
